...
public class UserJDBCDao extends UserDao {
    ...
    public void save(User user) {
        PreparedStatement ps = null;
        try {
            ps = connection.prepareStatement("insert into User(login, password, firstname, lastname) values(?, ?, ?, ?)");
    ...
    protected void doChangePassword(String login, String password) {
        PreparedStatement ps = null;
        try {
            ps = connection.prepareStatement("update user set password = ? where login = ?");
